...
`build:web`は`index.html`に加えて`404.html`と`items/index.html`、`graph/index.html`、`repositories/index.html`を生成します。
...
| `src/domain/`        | 状態機械、teamとlabelの解決、追跡選定、停滞時間、severityのpure TypeScript                 |
