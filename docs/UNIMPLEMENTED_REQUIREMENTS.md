...
1. Codex の notification recommendation が通知選別へ渡らない
...
2. author と event actor を保存せず検索できない
...
3. relation contradiction の構造が永続化されない
...
4. repository cluster 単位で graph を閲覧できない
...
6. staleness.timezone が表示へ反映されない
