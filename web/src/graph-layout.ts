...
import type { ComponentGraphView, GraphViewEdge, GraphViewNode } from "./graph-model.js";
...
export function layoutComponentGraph(view: ComponentGraphView): GraphLayout {
